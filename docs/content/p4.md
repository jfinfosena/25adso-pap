...
Son parámetros opcionales que vienen después del `?` en la URL.
...
> FastAPI incluye `pydantic`, así que no necesitas instalarlo por separado.
...
##### ✅ Modelo `ProductoParcial` (para PATCH)
